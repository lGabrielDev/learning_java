...
### Praticando 
Crie um programa , onde o professor(usuário) vai inputar as notas dos alunos. Essas notas serão armazenadas em uma array. Trate as exceptions se o professor digitar uma String.
